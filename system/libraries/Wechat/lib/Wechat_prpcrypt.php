	...
	public function encrypt($text, $appid) {
		try {
			...
			return array (
					...
					ErrorCode::getErrText ( ErrorCode::$EncryptAESError ) 
			);
		}
	}
	...
	public function decrypt($encrypted, $appid) {
		try {
			...
			return array (
					...
					ErrorCode::getErrText ( ErrorCode::$DecryptAESError ) 
			);
		}
		try {
			$pkc_encoder = new PKCS7Encoder ();
			...
			return array (
					...
					ErrorCode::getErrText ( ErrorCode::$IllegalBuffer ) 
			);
		}
		if ($from_appid != $appid) {
			return array (
					ErrorCode::$ValidateAppidError,
					ErrorCode::getErrText ( ErrorCode::$ValidateAppidError ) 
			);
		}
